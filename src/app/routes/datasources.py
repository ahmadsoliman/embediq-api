...
async def create_datasource(
    ...
    try:
        ...
        storage_service = ConfigurationStorageService()

        # Save the configuration
        saved_config = await storage_service.save_config(user_id, config)
...
async def list_datasources(
    ...
    try:
        ...
        configs = await storage_service.list_configs(user_id)
...
async def get_datasource(
    ...
    try:
        ...
        config = await storage_service.get_config(user_id, str(id))
...
async def update_datasource(
    ...
    try:
        ...
        updated_config = await storage_service.update_config(user_id, str(id), config)
...
async def delete_datasource(
    ...
    try:
        ...
        deleted = await storage_service.delete_config(user_id, str(id))
...
async def validate_datasource(
    ...
    try:
        ...
        result = await validation_service.validate_config(config)
